OS.registerApp({
    id: 'com.monacoeditor.codeeditor [webres]',
    name: 'Monaco Editor',
    icon: 'cde.png',
    tpicon: '📲',
    width: '950px',
        ...
        container.innerHTML = `
            ...
            <div class="app-wrapper">
                ...
                <iframe 
                    id="bb-frame" 
                    class="app-content" 
                    src="https://microsoft.github.io/monaco-editor/playground.html?source=v0.55.1#example-creating-the-editor-hello-world"
